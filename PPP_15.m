...
[fil,path]=uigetfile('C:\Users\pascal\Desktop\igs18360.sp3','Select sp3 File');
fid=fopen([path,fil],'r');
SP3 = SP3_File_Read(fid);
[k1,k2]=size(obs);
tmn1=mjuliandate('2015-03-15');
tmn2=mjuliandate('2015-03-14');
% tmn1 = juliandate(datetime('2015-03-15 00:00:00')) - juliandate(datetime('2000-01-01 12:00));0:00'));
rrcv=[2874042.8280 -5356829.5000  1923453.4320];
r0=rrcv;
